...
const _newsKey = require('./api/newsConfig')
...
componentDidMount() {
  ...
  fetch('https://newsapi.org/v1/articles?source=bbc-news&sortBy=top&apiKey=' + _newsKey, {
    'headers': {'Accept': 'application/json'}
  })
  .then(res  => res.json())
  // Returns results and shows top five news articles from BBC
